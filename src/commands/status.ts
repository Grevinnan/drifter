...
exports.handler = async (argv: any) => {
  ...
  if (argv.config) {
    ...
    let form = new tkit.Form({
      ...
      inputs: [
        ...
        },
        {
          ...
          value: 1,
          items: [
            {content: 'include', value: 1},
            {content: 'exclude', value: 2},
          ],
        },
        {
          key: 'statuses',
    ...
    function onSubmit(value: any) {
      ...
      terminal.saveCursor();
      terminal.moveTo.styleReset.eraseLine(1, 24, 'Submitted: %J\n', value);
    ...
    for (let s of statuses) {
      ...
      terminal.blue(`${s}\n`);
      let statusIssues =
          _.filter(issues, (i: any) => status(i).toLowerCase() === s);
